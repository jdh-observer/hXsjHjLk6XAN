...
```python editable=true jdh={"module": "object", "object": {"source": ["Missing title"], "type": "image"}} slideshow={"slide_type": ""} tags=["figure-langcompare-*"]
import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
import html
